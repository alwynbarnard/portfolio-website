...
export const projects: ProjectContainer[] = [
  {
    ...
    projectImageSrcs: ['../src/assets/Images/Betway-1.png','../src/assets/Images/Betway-2.png','../src/assets/Images/Betway-3.png','../src/assets/Images/Betway-4.png','../src/assets/Images/Betway-5.png'],
    projectTools: [
      'HTML',
      'CSS',
      'VueJS',
